...
void CGLRenderer::SetData()
{
	...
	glm::mat4 fullTransformMatrizes[] = {
		glm::rotate(glm::translate(projectionMatrix, glm::vec3(-1.5f, .0f, -3.0f)), 20.0f, glm::vec3(.0f, 1.0f, .0f)),
		glm::rotate(glm::translate(projectionMatrix, glm::vec3(1.0f, .0f, -3.75f)), 43.0f, glm::vec3(1.0f, .0f, .0f))
	};
	glBufferData(GL_ARRAY_BUFFER, sizeof(fullTransformMatrizes), fullTransformMatrizes, GL_STATIC_DRAW);
